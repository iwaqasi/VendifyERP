...
class Product extends Model
{
    ...
    {
        if (! empty($this->image)) {
            // Per-business folder: public/uploads/img/{business_id}/{filename}
            $image_path = public_path('uploads').'/'.config('constants.product_img_path').'/'.$this->business_id.'/'.$this->image;
        } else {
            $image_path = null;
        }
