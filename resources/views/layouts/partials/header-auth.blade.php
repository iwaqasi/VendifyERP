...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="tw-absolute tw-top-2 md:tw-top-5 tw-left-4 md:tw-left-8 tw-flex tw-items-center tw-gap-4"
            ...
            <a href="{{ url('/') }}" class="tw-flex tw-items-center tw-gap-3">
                <div
                    class="tw-w-10 tw-h-10 md:tw-w-12 md:tw-h-12 tw-flex tw-items-center tw-justify-center tw-overflow-hidden tw-rounded-lg tw-bg-white/10 tw-ring-1 tw-ring-white/20">
                    <img src="{{ asset('img/vendify-logo-mark.png') }}" alt="{{ config('app.name') }} logo"
                        class="tw-object-fill tw-w-7 tw-h-7 md:tw-w-9 md:tw-h-9" />
                </div>
                <span class="tw-text-white tw-font-bold tw-text-base md:tw-text-lg"
                    style="font-family: var(--vf-font-heading);">{{ config('app.name') }}</span>
            </a>
