...
@php
    ...
    // VendifyERP brand defaults (deep navy + teal accent) replace the stock
    // blue "primary" theme. Explicitly chosen themes are still respected.
    if ($themeColor === 'primary') {
        $tc = ['700' => '#0D9488', '800' => '#1E3A5F', '900' => '#142B47'];
    }
@endphp
<style>
    :root {
...
<!-- VendifyERP enterprise design system -->
<link rel="stylesheet" href="{{ asset('css/vendify.css?v='.$asset_v) }}">
<!-- VendifyERP column-visibility dropdown styling -->
<link rel="stylesheet" href="{{ asset('css/vendify-colvis.css?v='.$asset_v) }}">
