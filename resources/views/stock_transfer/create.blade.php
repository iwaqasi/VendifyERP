    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-solid'])
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#product_selector_transfer" style="margin-top: 5px;">
...
@section('javascript')
    ...
    @include('components.product_selector', ['id' => 'product_selector_transfer', 'on_select' => 'onTransferProductSelected', 'categories' => $categories ?? []])
    <script type="text/javascript">
        function onTransferProductSelected(products) {
            if (!products || products.length === 0) return;
            var addNext = function(index) {
                if (index >= products.length) return;
                var p = products[index];
                var variationId = p.variation_id || p.id;
                stock_transfer_product_row(variationId);
