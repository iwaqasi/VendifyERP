...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('name_ar', __('product.product_name') . ' (العربية):') !!}
                {!! Form::text('name_ar', !empty($duplicate_product->name_ar) ? $duplicate_product->name_ar : null, ['class' => 'form-control', 'dir' => 'rtl',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('barcode', !empty($duplicate_product->barcode) ? $duplicate_product->barcode : null, ['class' => 'form-control',
    ...
    <div class="row">
        ...
        @foreach($product_custom_fields as $index => $cf)
            @if(!empty($cf))
                @php
                    $cf_no = (int) str_replace('custom_field_', '', $index);
                    $db_field_name = 'product_custom_field' . $cf_no;
                    $cf_type = !empty($product_cf_details[$cf_no]['type']) ? $product_cf_details[$cf_no]['type'] : 'text';
                    $dropdown = !empty($product_cf_details[$cf_no]['dropdown_options']) ? explode(PHP_EOL, $product_cf_details[$cf_no]['dropdown_options']) : [];
                @endphp
