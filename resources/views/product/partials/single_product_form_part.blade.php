        ...
        <tr>
          ...
          <td>
            ...
            <div class="checkbox" style="margin-top: 5px;">
                <label>
                    {!! Form::checkbox('is_flexible_price', 1, !empty($product->is_flexible_price) ? $product->is_flexible_price : false, ['class' => 'input-icheck', 'id' => 'is_flexible_price']); !!} <strong>@lang('Flexible Price')</strong>
                </label>
                <p class="help-block"><small>@lang('Allow price to be changed when adding to bookings')</small></p>
            </div>
          </td>
          @if(empty($quick_add))
          <td>
