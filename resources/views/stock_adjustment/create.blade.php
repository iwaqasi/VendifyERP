...
@section('content')
    ...
    <section class="content-header">
        <br>
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Add Adjustment</h1>
        <!-- <ol class="breadcrumb">
    ...
    <section class="content no-print">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'adjustment_type',
                            ['normal' => 'Stock Adjustment', 'abnormal' => 'Cost Adjustment', 'price_adjustment' => 'Price Adjustment'],
                            null,
        ...
        @component('components.widget', ['class' => 'box-solid'])
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#product_selector_adj" style="margin-top: 5px;">
                        <i class="fa fa-th-list"></i> Select Product
                    </button>
                </div>
            </div>
            <div class="row">
...
@section('javascript')
    ...
    @include('components.product_selector', ['id' => 'product_selector_adj', 'on_select' => 'onAdjProductSelected', 'categories' => $categories ?? []])
    <script type="text/javascript">
        function onAdjProductSelected(products) {
            if (!products || products.length === 0) return;
            var addNext = function(index) {
                if (index >= products.length) return;
                var p = products[index];
                var variationId = p.variation_id || p.id;
