        ...
        @component('components.widget', ['class' =>  'pos-tab-container'])
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu tw-rounded-lg">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base tw-text-cyan-600"><i class="fa fa-building tw-mr-1"></i> Business Type</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                <!-- tab 1 end -->
                <!-- tab 1b: Business Type -->
                @include('business.partials.settings_business_type')
                <!-- tab 1b end -->
                <!-- tab 2 start -->
