...
| Primary Light | `#2E5A8A` | `--color-primary-light` |
| Secondary | `#334155` | `--color-secondary` |
| Accent/CTA | `#0D9488` | `--color-accent` |
| Accent Light | `#14B8A6` | `--color-accent-light` |
...
| `--shadow-md` | `0 4px 6px rgba(15,23,42,0.1)` | Cards, buttons |
| `--shadow-lg` | `0 10px 15px rgba(15,23,42,0.1)` | Modals, dropdowns |
| `--shadow-xl` | `0 20px 25px rgba(15,23,42,0.15)` | Hero images, featured cards |
