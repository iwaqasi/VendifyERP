...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/products/category/upload-image', [ProductController::class, 'uploadCategoryImage']);
    Route::delete('/products/category/{id}/image', [ProductController::class, 'deleteCategoryImage']);
    Route::get('/products/get_sub_units', [ProductController::class, 'getSubUnits']);
    Route::get('/products/get-products-for-selector', [ProductController::class, 'getProductsForSelector']);
    ...
    // POS Dashboard - must be before Route::resource('pos') to avoid being caught by pos/{po}
    ...
    Route::get('restaurant/bookings/get-todays-bookings', [Restaurant\BookingController::class, 'getTodaysBookings']);
    Route::resource('restaurant/bookings', Restaurant\BookingController::class, ['as' => 'restaurant.bookings']);
    Route::post('restaurant/bookings/{id}/convert-to-invoice', [Restaurant\BookingController::class, 'convertToInvoice']);

    // Staff Schedules
    Route::get('staff-schedules', [\App\Http\Controllers\StaffScheduleController::class, 'index']);
    Route::post('staff-schedules', [\App\Http\Controllers\StaffScheduleController::class, 'store']);
    Route::get('staff-schedules/available-staff', [\App\Http\Controllers\StaffScheduleController::class, 'getAvailableStaff']);
    Route::post('staff-schedules/check-availability', [\App\Http\Controllers\StaffScheduleController::class, 'checkAvailability']);
...
//common route
// GET logout for header link (Auth::routes only registers POST)
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::prefix('cms')->name('cms.')->group(function () {
        Route::get('/', [App\Http\Controllers\CmsController::class, 'dashboard'])->name('dashboard');
        
        // Website Designer
        Route::get('/designer', [App\Http\Controllers\CmsController::class, 'designer'])->name('designer');
        Route::post('/designer/save', [App\Http\Controllers\CmsController::class, 'saveDesign'])->name('designer.save');
        Route::get('/preview', [App\Http\Controllers\CmsController::class, 'preview'])->name('preview');
        
        // Pages
        Route::get('/pages', [App\Http\Controllers\CmsController::class, 'pages'])->name('pages');
        Route::get('/pages/create', [App\Http\Controllers\CmsController::class, 'pageCreate'])->name('pages.create');
        Route::post('/pages/store', [App\Http\Controllers\CmsController::class, 'pageStore'])->name('pages.store');
        Route::get('/pages/{id}/edit', [App\Http\Controllers\CmsController::class, 'pageEdit'])->name('pages.edit');
        Route::put('/pages/{id}/update', [App\Http\Controllers\CmsController::class, 'pageUpdate'])->name('pages.update');
        Route::delete('/pages/{id}/delete', [App\Http\Controllers\CmsController::class, 'pageDelete'])->name('pages.delete');
        
        // Blog Posts
        Route::get('/posts', [App\Http\Controllers\CmsController::class, 'posts'])->name('posts');
        Route::get('/posts/create', [App\Http\Controllers\CmsController::class, 'postCreate'])->name('posts.create');
        Route::post('/posts/store', [App\Http\Controllers\CmsController::class, 'postStore'])->name('posts.store');
        Route::get('/posts/{id}/edit', [App\Http\Controllers\CmsController::class, 'postEdit'])->name('posts.edit');
        Route::put('/posts/{id}/update', [App\Http\Controllers\CmsController::class, 'postUpdate'])->name('posts.update');
        Route::delete('/posts/{id}/delete', [App\Http\Controllers\CmsController::class, 'postDelete'])->name('posts.delete');
        
        // Banners
        Route::get('/banners', [App\Http\Controllers\CmsController::class, 'banners'])->name('banners');
        Route::get('/banners/create', [App\Http\Controllers\CmsController::class, 'bannerCreate'])->name('banners.create');
        Route::post('/banners/store', [App\Http\Controllers\CmsController::class, 'bannerStore'])->name('banners.store');
        Route::get('/banners/{id}/edit', [App\Http\Controllers\CmsController::class, 'bannerEdit'])->name('banners.edit');
        Route::put('/banners/{id}/update', [App\Http\Controllers\CmsController::class, 'bannerUpdate'])->name('banners.update');
        Route::delete('/banners/{id}/delete', [App\Http\Controllers\CmsController::class, 'bannerDelete'])->name('banners.delete');
        
        // Menus
        Route::get('/menus', [App\Http\Controllers\CmsController::class, 'menus'])->name('menus');
        Route::post('/menus/store', [App\Http\Controllers\CmsController::class, 'menuStore'])->name('menus.store');
        Route::delete('/menus/{id}/delete', [App\Http\Controllers\CmsController::class, 'menuDelete'])->name('menus.delete');
        Route::post('/menus/reorder', [App\Http\Controllers\CmsController::class, 'menuReorder'])->name('menus.reorder');
        
        // Testimonials
        Route::get('/testimonials', [App\Http\Controllers\CmsController::class, 'testimonials'])->name('testimonials');
        Route::post('/testimonials/store', [App\Http\Controllers\CmsController::class, 'testimonialStore'])->name('testimonials.store');
        Route::delete('/testimonials/{id}/delete', [App\Http\Controllers\CmsController::class, 'testimonialDelete'])->name('testimonials.delete');
        
        // FAQs
        Route::get('/faqs', [App\Http\Controllers\CmsController::class, 'faqs'])->name('faqs');
        Route::post('/faqs/store', [App\Http\Controllers\CmsController::class, 'faqStore'])->name('faqs.store');
        Route::delete('/faqs/{id}/delete', [App\Http\Controllers\CmsController::class, 'faqDelete'])->name('faqs.delete');
        
        // Media Library
        Route::get('/media', [App\Http\Controllers\CmsController::class, 'media'])->name('media');
        Route::post('/media/upload', [App\Http\Controllers\CmsController::class, 'mediaUpload'])->name('media.upload');
        Route::delete('/media/{id}/delete', [App\Http\Controllers\CmsController::class, 'mediaDelete'])->name('media.delete');
    });
});

// ============================================================
// VendifyPOS Web - Flutter Web POS
// Serves the Flutter web build from public/pos/
// Cashiers access this at: https://erp.arksoftsolutions.com/pos/
// ============================================================
Route::get('/vendify-pos', function () {
    return response()->file(public_path('vendify-pos/index.html'));
});