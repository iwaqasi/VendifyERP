...
class PackagesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'description', 'location_count', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days', 'price', 'sort_order', 'is_active', 'mark_package_as_popular', 'custom_permissions', 'is_private', 'is_one_time', 'enable_custom_link', 'custom_link',
                'custom_link_text', 'businesses', 'flutter_pos', 'flutter_cms' ]);
            $currency = System::getCurrency();
            ...
            $input['flutter_pos'] = empty($input['flutter_pos']) ? 0 : 1;
            $input['flutter_cms'] = empty($input['flutter_cms']) ? 0 : 1;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $packages_details['flutter_pos'] = empty($packages_details['flutter_pos']) ? 0 : 1;
            $packages_details['flutter_cms'] = empty($packages_details['flutter_cms']) ? 0 : 1;
