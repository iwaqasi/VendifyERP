...
function update_inline_profit_percentage(row) {
    ...
    if (purchase_after_tax > 0) {
        profit_percent = __get_rate(purchase_after_tax, default_sell_price_in_base_currency);
    }
    profit_percent = (isNaN(profit_percent) || !isFinite(profit_percent)) ? 0 : profit_percent;
